...
console.log("deeplAuthKey", deeplAuthKey);
...
//         // 번역 추가
//         const translatedTitle = language.lang === "fr" ? await translateText(t.title) : t.title;
//         const translatedDescription = language.lang === "fr" ? await translateText(t.description) : t.description;
//         const translatedContent = language.lang === "fr" ? await translateText(content) : content;
